    ...
    <section class="loginBox mt-5">
        <div class="loginContainer shadow">
            ...
            <form action="admin-login-process.php" method="post">
                <div class="row">
                    <div class="col-md-12">
                        <input class="inputStyle" type="text" name="adminId" placeholder="University ID">
                    </div>
                </div>
                <br>
                <div class="row">
                    <div class="col-md-12">
                        <input class="inputStyle" type="password" name="adminPass" placeholder="Password" required>
                    </div>
                </div>
                <br>
                <div class="row ">
